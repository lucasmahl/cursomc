...
import com.lucasmahl.cursomc.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		// produtos conhecem suas categorias
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "lucasteste@hotmail.com", "56214970073", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "anacostateste@hotmail.com", "64364871079", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("34739999", "999998888"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", null, "Centro", "36250165", cli2, c2);
		...
		// pagamento 1 é do pedido 1
		ped1.setPagamento(pagto1);

		// data do pagamento nulo pq não foi pago
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("20/10/2017 00:00"),
				null);

		// pagamento 2 é do pedido 2
		ped2.setPagamento(pagto2);

		// associar clientes aos pedidos
		...
		// Cada pedido conhece os seus itens
		ped1.getItens().addAll(Arrays.asList(ip1, ip2));
		ped2.getItens().addAll(Arrays.asList(ip3));

		// Cada produto conhece os seus itens
